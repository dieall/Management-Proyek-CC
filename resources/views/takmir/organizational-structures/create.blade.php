...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('organizational-structures.store') }}" method="POST">
            @csrf
            
            <div class="form-group">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_division" name="is_division" value="1" {{ old('is_division') ? 'checked' : '' }}>
            ...
            <div id="division_fields" style="display: {{ old('is_division') ? 'block' : 'none' }};">
                <div class="form-group">
                    <label for="division_name">Nama Divisi/Bagian <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('division_name') is-invalid @enderror" 
                           id="division_name" name="division_name" value="{{ old('division_name') }}">
                    @error('division_name')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('division_description') is-invalid @enderror" 
                              id="division_description" name="division_description" rows="3">{{ old('division_description') }}</textarea>
            ...
            <div id="position_fields" style="display: {{ old('is_division') ? 'none' : 'block' }};">
                <div class="form-group">

...
@section('title', 'Tambah Tugas & Tanggung Jawab')

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Tugas & Tanggung Jawab Baru</h1>
</div>

<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Tugas & Tanggung Jawab</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('job-responsibilities.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('task_description') is-invalid @enderror" 
                          id="task_description" name="task_description" rows="4">{{ old('task_description') }}</textarea>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control @error('frequency') is-invalid @enderror" id="frequency" name="frequency" required>
                            ...
                            <option value="on_demand" {{ old('frequency', 'on_demand') == 'on_demand' ? 'selected' : '' }}>Sesuai Kebutuhan</option>
                        </select>
                        @error('frequency')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-group">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_core_responsibility" name="is_core_responsibility" value="1" {{ old('is_core_responsibility') ? 'checked' : '' }}>

...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('muzakki.update', $muzakki) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <textarea id="alamat" name="alamat" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('alamat', $muzakki->alamat) }}</textarea>
        ...
        <div class="flex gap-2 pt-4 border-t">
            ...
            <a href="{{ route('muzakki.show', $muzakki) }}" class="bg-gray-400 text-white px-6 py-2 rounded hover:bg-gray-500">

...
<div class="bg-white rounded-lg shadow p-6 mb-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('muzakki.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                ...
                @forelse($muzakki as $item)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 text-center text-sm">
                            <a href="{{ route('muzakki.show', $item) }}" class="text-blue-600 hover:text-blue-800 mr-2">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('muzakki.edit', $item) }}" class="text-yellow-600 hover:text-yellow-800 mr-2">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('muzakki.destroy', $item) }}" method="POST" class="inline" onsubmit="return confirm('Yakin?')">
                                @csrf
                                @method('DELETE')
